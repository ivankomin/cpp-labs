    ...
    case WM_PAINT:
        {
            ...
            int vscrollHeight = GetSystemMetrics(SM_CYVSCROLL);

            std::wstring text =
                L"Program icon width: " + std::to_wstring(iconWidth) + L" px\n" +
                L"Program icon height: " + std::to_wstring(iconHeight) + L" px\n" +
                L"Vertical scrollbar width: " + std::to_wstring(vscrollWidth) + L" px\n" +
                L"Vertical scrollbar button height: " + std::to_wstring(vscrollHeight) + L" px";
